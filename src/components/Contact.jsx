...
export const Contact = () => {
    ...
    return <div id='contact' style={{ '--bglightproject': light ? "#edf2f8" : "#0a192f", '--plight': light ? 'black' : 'white', '--namelight': light ? "#dc143c" : "#64ffda", '--rolelight': light ? "white" : "#152235" }}>
            ...
            <div id='contactDetSec'>
                ...
                <div>
                    <div className='contactOption'>
                        ...
                        <a href='tel:9334072889'>+91 7976399169</a>
                    </div>
                    <div className='contactOption'>
                        <MdEmail className='contactIcon' />
                        <a href='mailto:harshmaharshi571@gmail.com'>harshmaharshi571@gmail.com</a>
                    </div>
                    <div className='contactOption'>
                        <BsGithub className='contactIcon' />
                        <a href='https://github.com/Harsh252-dot' target='_blank'>GitHub</a>
                    </div>
                    <div className='contactOption'>
                        <BsLinkedin className='contactIcon' />
                        <a href='https://www.linkedin.com/in/harsh-maharshi-756b912a5/' target='_blank'>LinkedIn</a>
                    </div>
                    <div className='contactOption'>
                        <MdLocationOn className='contactIcon' />
                        <a>Ratangarh, Rajasthan</a>
                    </div>
                </div>
            </div>
        ...
        <div id='creator'>
            <p>Designed & Built by Harsh Maharshi</p>
        </div>
    </div>
}